...
function university_files(){
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyChDOmpz4_TzPA_JO2U2WvQnKetx_Gl8hk', NULL, '1.0', true);
...
function universityMapKey($api) {
    $api['key'] = 'AIzaSyChDOmpz4_TzPA_JO2U2WvQnKetx_Gl8hk';
    return $api;
}
